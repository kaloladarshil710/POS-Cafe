...
.method-opt.selected{border-color:var(--primary);background:var(--primary-dim);box-shadow:0 0 0 3px rgba(200,96,42,0.1);}
...
.pay-btn{width:100%;padding:16px;background:var(--primary);color:white;border:none;border-radius:14px;font-family:'DM Sans',sans-serif;font-size:15px;font-weight:800;cursor:pointer;transition:0.18s;}
.pay-btn:hover{background:var(--primary-dark);transform:translateY(-2px);box-shadow:0 10px 28px rgba(200,96,42,0.3);}
...
.btn-cancel{background:var(--surface2);border:1px solid var(--border);border-radius:12px;padding:13px;font-family:'DM Sans',sans-serif;font-size:14px;font-weight:700;cursor:pointer;}
.btn-cancel:hover{background:var(--border);}
.btn-confirm{background:var(--green);border:none;border-radius:12px;padding:13px;font-family:'DM Sans',sans-serif;font-size:14px;font-weight:700;color:white;cursor:pointer;width:100%;}
...
.confirm-amount-value{font-size:38px;font-weight:800;color:#C8602A;}
...
.pin-key{background:var(--surface2);border:1px solid var(--border);border-radius:14px;padding:16px;font-size:20px;font-weight:700;cursor:pointer;transition:0.15s;font-family:'DM Sans',sans-serif;}
...
<div class="page">
 ...
 $m_meta = [
 'Cash' => [
   'icon'=>'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#12B76A" stroke-width="2"><rect x="2" y="6" width="20" height="12" rx="2"/><circle cx="12" cy="12" r="2"/></svg>',
   'desc'=>'Collect cash from customer'
 ],
 'Digital' => [
   'icon'=>'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#C8602A" stroke-width="2"><rect x="2" y="5" width="20" height="14" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/></svg>',
   'desc'=>'Card / Bank transfer / NetBanking'
 ],
 'UPI' => [
   'icon'=>'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#6366F1" stroke-width="2"><rect x="3" y="3" width="6" height="6"/><rect x="15" y="3" width="6" height="6"/><rect x="3" y="15" width="6" height="6"/></svg>',
   'desc'=>'Show QR code for UPI scan'
 ],
];
