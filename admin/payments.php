...
.method-option.selected{border-color:var(--primary);background:var(--primary-dim);box-shadow:0 0 0 3px rgba(249,115,22,0.12);}
...
.btn-cancel-modal{background:var(--surface2);border:1px solid var(--border);border-radius:12px;padding:13px;font-family:'Plus Jakarta Sans',sans-serif;font-size:14px;font-weight:700;cursor:pointer;transition:0.15s;}
.btn-cancel-modal:hover{background:var(--border);}
.btn-confirm-upi{background:var(--green);border:none;border-radius:12px;padding:13px;font-family:'Plus Jakarta Sans',sans-serif;font-size:14px;font-weight:700;color:white;cursor:pointer;transition:0.15s;}
...
function processPayment(){
  ...
  document.getElementById('payBtn').textContent = "Processing Payment...";
  document.getElementById('payBtn').disabled = true;

  setTimeout(function(){
    document.getElementById('payMethodInput').value = sel;
